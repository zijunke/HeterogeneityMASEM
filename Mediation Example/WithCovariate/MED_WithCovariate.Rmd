...
opts_knit$set(root.dir = 'D:/Research/2023/CompareMASEM/MED/WithCovariate/')
```
...
vR    = as.as.col_spec()= as.matrix(dat[,c('rXM','rXY','rMY')]) # bivariate correlations
...
T0TF = diag(TRUE,3)
T0TF[3,3] = FALSE
T0 <- create.Tau2(RAM=RAM0, RE.type="User", RE.User = T0TF, Transform="expLog", RE.startvalues=0.05)
