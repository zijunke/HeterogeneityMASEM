...
opts_knit$set(root.dir = 'D:/Research/2023/CompareMASEM/CFA/Bifactor/NoCovariate/')
```
...
# Working directory
wd = 'D:/Research/2023/CompareMASEM/CFA/Bifactor/NoCovariate/'
setwd(wd)
```
...
data<-list("Nstudy","N","Ninv","mu.N",'p',"pp","j","k","j10","k10",'ind',
	"vR","tau.vR",'Z','V.theta',"mu.vR.psi",'alpha.prior.vE','beta.prior.vE') # data

initsl <- list(list(mu.L=rep(.6,p*2),sd.L=rep(0.1,20),tau.R=mu.N*3,
	vR.psi=matrix(0,Nstudy,pp),vR.rep = vR))# Initial values
